...
public class ViewingMarketplaceSuperUserAppointmentsQuery: GraphQLQuery {
  public static let operationName: String = "ViewingMarketplaceSuperUserAppointmentsQuery"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query ViewingMarketplaceSuperUserAppointmentsQuery($id: ID!, $status: [String!], $ordering: String!, $labels: [String!]) { viewing(org: $id) { __typename org { __typename id name services(status: $status, ordering: $ordering) { __typename ...MarketplaceAppointmentService } users(role: "provider") { __typename nodes { __typename id addresses { __typename ...AddressModel } } } } } }"#,
  ...
  public struct Data: ZalaAPI.SelectionSet {
    ...
    public static var __selections: [ApolloAPI.Selection] { [
      .field("viewing", Viewing?.self, arguments: ["org": .variable("id")]),
    ] }
      ...
      public struct Org: ZalaAPI.SelectionSet {
        ...
        public struct Users: ZalaAPI.SelectionSet {
          ...
          public struct Node: ZalaAPI.SelectionSet {
            ...
            /// Viewing.Org.Users.Node.Address
            ///
