...
public class MetricsByCategoriesQuery: GraphQLQuery {
  public static let operationName: String = "MetricsByCategories"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query MetricsByCategories($categories: [String!]) { application { __typename metrics(categories: $categories) { __typename ...MetricModel } } }"#,
      fragments: [MetricModel.self]
    ))

  public var categories: GraphQLNullable<[String]>

  public init(categories: GraphQLNullable<[String]>) {
    self.categories = categories
  }

  public var __variables: Variables? { ["categories": categories] }
  ...
  public struct Data: ZalaAPI.SelectionSet {
    ...
    public struct Application: ZalaAPI.SelectionSet {
      ...
      public static var __selections: [ApolloAPI.Selection] { [
        ...
        .field("metrics", [Metric]?.self, arguments: ["categories": .variable("categories")]),
      ] }
