...
public class MarketPlaceRoutineForUserQuery: GraphQLQuery {
  public static let operationName: String = "MarketPlaceRoutineForUserQuery"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query MarketPlaceRoutineForUserQuery($id: ID, $ids: [ID!], $labels: [String!], $taskStatus: String) { user(id: $id) { __typename carePlans(ids: $ids) { __typename ...MarketPlaceRoutine } } }"#,
