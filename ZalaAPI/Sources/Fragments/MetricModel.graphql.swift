...
public struct MetricModel: ZalaAPI.SelectionSet, Fragment {
  public static var fragmentDefinition: StaticString {
    #"fragment MetricModel on Metric { __typename id key labels names title storedAs units cumulative }"#
  }
