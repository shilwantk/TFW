...
public struct MarketplaceAppointmentService: ZalaAPI.SelectionSet, Fragment {
  public static var fragmentDefinition: StaticString {
    #"fragment MarketplaceAppointmentService on Service { __typename id attachments(labels: $labels) { __typename ...AttachmentModel } desc groupPrimary kind organizationId status title durationMins params supportsVirtual addresses { __typename ...AddressModel } }"#
  }
