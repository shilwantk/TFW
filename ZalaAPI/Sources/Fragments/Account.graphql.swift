...
public struct Account: ZalaAPI.SelectionSet, Fragment {
  public static var fragmentDefinition: StaticString {
    #"fragment Account on User { __typename id addresses { __typename ...AddressModel } attachments(labels: $labels) { __typename ...AttachmentModel } emails { __typename ...EmailModel } phones { __typename ...PhoneNumberModel } roles { __typename ...UserRole } firstName lastName fullName initials dob preferences { __typename ...PreferenceModel } }"#
  }
