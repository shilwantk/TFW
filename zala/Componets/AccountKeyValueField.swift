...
struct AccountKeyValueField: View {
...
#Preview {
    AccountKeyValueField(key: "Last Name", value: .constant(""), placeholder: "Enter Last Name")
}


extension AccountKeyValueField {
    func onUpdate(action: @escaping ((_ value: String) -> Void)) -> AccountKeyValueField {
        AccountKeyValueField(key: self.key, value: $value, placeholder:self.placeholder, height: self.height, onUpdate: action)
    }
}
